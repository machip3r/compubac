...
define('CONTACTFORM_FROM_ADDRESS', 'compubac@gmail.com'); //your mail for sending
...
define('CONTACTFORM_TO_NAME', 'CompuBac');
...
define('CONTACTFORM_SMTP_USERNAME', 'compubac@gmail.com');
define('CONTACTFORM_SMTP_PASSWORD', 'CompuBac1201');
